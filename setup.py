...
setup(cmdclass={'install_data': install_data},
        ...
        scripts=['scripts/hermodwritel22db','scripts/hermodrerun','scripts/hermodgetl1','scripts/hermodlastdays','scripts/hermodgetweather','pbs_scripts/healthcheck','scripts/hermodrunjob'],
