...
from os.path import dirname,isdir,split,join,basename
...
class Ecmwf_Grib2(object):
    def __init__(self,grib_filename):
        ...
        self.time = datetime.strptime(basename(self.filename),'ECMWF_ODIN_%Y%m%d%H%M+000H00M')
