...
STYLESHEETS = (
    {'id': "odinsmrsite_skin.css", 'media': 'screen', 'rendering': 'import'},
        )
...
# CHANGE the following dictionary to declare the display views that must be
#  registered for content types in the portal_types tool.
#  Dictionary keys specify the portal types that will have more views
#  registered in the tool, their value must be a tuple containing the name of
#  those views (template id - without the .pt or .cpt suffix).
DISPLAY_VIEWS = {
#     'Topic' : ('new_view_id_1', 'my_other_cool_view'),
          }
